...
public class SpringbootBibliotecaApplication {
	...
	public OpenAPI customOpenApi(){
		return new OpenAPI()
					...
					.addTagsItem(new Tag().name("Login").description("Aquí se realiza el login."))
					...
					.addTagsItem(new Tag().name("Préstamos").description("Operaciones relacionadas con los préstamos."))
